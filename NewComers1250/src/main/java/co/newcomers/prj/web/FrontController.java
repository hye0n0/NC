...
import co.newcomers.prj.member.command.AuthCodeCheck;
...
public class FrontController extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		map.put("/contactForm.do", new ContactForm()); //지도 폼 호출
		
		map.put("/confirmEmailForm.do", new ConfirmEmailForm()); //이메일 인증 폼 호출
		map.put("/confirmEmail.do", new ConfirmEmail()); //인증번호 발송.
		map.put("/authCodeCheck.do", new AuthCodeCheck()); //인증번호 확인
