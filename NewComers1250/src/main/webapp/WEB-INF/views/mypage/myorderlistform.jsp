          ...
          <tbody>
              ...
              <tr>
                  <td>
                      <div class="media">
                          <div class="d-flex">
                              <img src="upload/item/${s.itemImage }" alt="" width="200px" height="200px">
                          </div>
                  ...
                  <td>
                    ...
                    <button class="button button-confirm mr-auto mb-1" type="submit" width="30px" height="30px" onclick="shipConfirm(this)">구매확정</button>
                  </td>
              </tr> 
             </c:forEach>             
          </tbody>
